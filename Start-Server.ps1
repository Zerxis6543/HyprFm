...
$StdbDb      = "fivem-game"
$FxPort      = "30120"
$SidecarPath = "G:\FIVEMSTDBPROJECT\HyprFm\stdb-sidecar"
$FxServerExe = "G:\FIVEMSTDBPROJECT\HyprFm\fxserver\FXServer.exe"
$ServerData  = "G:\FIVEMSTDBPROJECT\HyprFm\fivem-server-files"
