...
static class ItemSeed
{
    ...
    public static readonly ItemDef[] Items =
    {
        ...
        new("cash",          "Cash",           0.01f, true,  false, 1000, "misc",      "prop_amb_cash_note"),
        new("phone",         "Phone",          0.1f,  false, true,  1,    "phone",     "prop_npc_phone_02"),
        new("weapon_pistol", "Pistol",         1.5f,  false, false, 1,    "weapon",    "prop_w_pi_pistol"),
        new("ammo_pistol",   "Pistol Ammo",    0.05f, true,  false, 250,  "misc",      "prop_box_ammo01a"),
        new("weapon_knife",  "Knife",          0.5f,  false, false, 1,    "weapon",    "prop_cs_knife_01"),
        new("assault_rifle", "Assault Rifle",  4.5f,  false, false, 1,    "weapon",    "prop_w_ar_assaultrifle"),
